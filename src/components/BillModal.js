    ...
    <Modal title="🧾 Create New Bill" onClose={onClose} wide>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <div style={{ background: "#fff8f8", borderRadius: 12, border: `1px solid ${C.border}`, overflow: "visible" }}>
          {/* Header */}
          <div className="mobile-item-header" style={{ display: "grid", gridTemplateColumns: "1fr 70px 90px 100px 28px", gap: 8, padding: "8px 12px", background: "#fef0f0", borderBottom: `1px solid ${C.border}`, borderRadius: "12px 12px 0 0" }}>
          ...
          {lockedItems.map((it, i) => (
            <div key={i} className="mobile-item-row" style={{ display: "grid", gridTemplateColumns: "1fr 70px 90px 100px 28px", gap: 8, padding: "8px 12px", borderBottom: `1px solid ${C.border}`, alignItems: "center", background: i % 2 === 0 ? "#fff" : "#fffcfc" }}>
          ...
          {/* Active search row */}
          <div className="mobile-item-row" style={{ display: "grid", gridTemplateColumns: "1fr 70px 90px 100px 28px", gap: 8, padding: "8px 12px", alignItems: "center", overflow: "visible", background: "#fff8f8", borderTop: lockedItems.length > 0 ? `2px dashed ${C.border}` : "none" }}>
